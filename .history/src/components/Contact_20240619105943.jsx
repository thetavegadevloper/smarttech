...
function Contact() {
  ...
  {/* <!-- Contact End -->
   <!-- Quote Start --> */}
  <div class="container-fluid  overflow-hidden px-lg-0" style={{margin: "6rem 0 "  , backgroundColor : "rgb(247, 247, 247)" , position: "relative"  ,bottom: "100px"}}  >
          ...
          <div class="row g-0 mx-lg-0">
              ...
              <div class="col-lg-6 quote-text py-5 wow fadeIn" data-wow-delay="0.5s">
                  <div class="p-lg-5 pe-lg-0">
                      ...
                      <p class="mb-4 pb-2">"Each solar project is unique. Fill out the form below with your specifics, and our experts will tailor a solution that meets your energy needs and budget."</p>
                      <form>
                          <div class="row g-3">
