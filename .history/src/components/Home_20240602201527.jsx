...
function Home() {
 ...
 <div className='hero'>
    ...
    <div className='content'> 
        <h1 className='text-center'>Welcome to Smart Tech Solutions</h1>
        <p> At Smart Tech Solutions, we are committed to bringing innovative technology solutions to homes and businesses, empowering you to embrace the future with sustainable energy and advanced automation. </p>
