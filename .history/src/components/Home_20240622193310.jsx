    ...
    <div className="container-xxl py-5">
        <div className="container">
            ...
            <div className="row g-4">
                ...
                <div className="col-md-6 col-lg-4 wow fadeInUp" data-aos="fade-up" data-aos-duration="4000">
                    <div className="service-item  overflow-hidden">
                ...
                <div className="col-md-6 col-lg-4 wow fadeInUp" data-aos="fade-up" data-aos-duration="5000">
                    <div className="service-item  overflow-hidden">
                ...
                <div className="col-md-6 col-lg-4 wow fadeInUp" data-aos="fade-up"  data-aos-duration="00">
                    <div className="service-item  overflow-hidden">
