...
function About() {
  return (
    ...
    <div className="custom-tagline " > <div className="col-md-12 text-center">
            ...
            <p className="about-us-description" style={{ textAlign: 'justify' }}>Who Are We : Smart Tech Solutions is a leading provider of technology solutions specializing in renewable energy and smart automation. with team of experienced professionals and a passion for innovation , we strive to deliver top-notch services tailored to our clients needs </p>
