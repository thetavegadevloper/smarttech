...
{/* header end  */}
    ...
    <div className="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style={{maxWidth: "600px"}}>
        <h6 className="text-success mt-5">Our Projects</h6>
        ...
        <div class="col-md-4">
          <div class="testimonial">
            ...
            <blockquote>
              ...
              <p>John Doe, CEO of ABC Corporation</p>
            </blockquote>
          </div>
        </div>
        <div class="col-md-4">
          <div class="testimonial">
            ...
            <blockquote>
              ...
              <p>Jane Smith, Marketing Manager at DEF Agency</p>
            </blockquote>
          </div>
        </div>
        <div class="col-md-4">
