    ...
    <div class="container">
      <div class="row">
        <div class="col-md-12 text-center">
          <h2 class="section-title">Checkout Our  Latest Projects </h2>
        </div>
      </div>
      <div class="row justify-content-center">
        <div class="col-md-4">
          <a href="#" class="project-container">
            <img src="Aboutus.jpg" alt="project 1" class="project-image"/>
          </a>
        </div>
        <div class="col-md-4">
          <a href="#" class="project-container">
            <img src="image2.jpg" alt="project 2" class="project-image"/>
          </a>
        </div>
        <div class="col-md-4">
          <a href="#" class="project-container">
            <img src="image3.jpg" alt="project 3" class="project-image"/>
          </a>
        </div>
      </div>
    </div>
