    ...
    {/* <!-- About Start --> */} 
      <div className="about-container">  
       <div className="about-img"> 
        <img src={gallery6} alt=""  height="400px" width="400px"></img>
       </div>
        <div className="about-text">
           <h4> About Us </h4>
           <h2> Who Are We :</h2>
           <p> Smart Tech Solutions is a leading provider of technology solutions specializing in renewable energy and smart automation. With a team of experienced professionals and a passion for innovation, we strive to deliver top-notch services tailored to our clients' needs.</p>
