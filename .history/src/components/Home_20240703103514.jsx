...
function Home() {
    ...
    const services = [
        {
          icon: <FaSolarPanel style={{ height: '50px', width: '50px' }} />,
          title: 'Solar Rooftop Solutions',
          description:
            'Design and installation: Tailored Solutions for residential, commercial, and industrial consumers.',
          image: project2,
        },
        {
          icon: <FaSolarPanel style={{ height: '50px', width: '50px' }} />,
          ...
          description:
            'Design and Installation: Comprehensive solutions for solar power generation.',
          image: service2,
        },
        {
          icon: <MdOutlineSupportAgent style={{ height: '50px', width: '50px' }} />,
          title: 'Luxury Home Automation',
          description:
            'Features: Control lighting, temperature, security, and entertainment systems seamlessly.',
          image: service3,
        },
        {
          icon: <GiTheater style={{ height: '50px', width: '50px' }} />,
          title: 'Home Theatres',
          description:
            'Audio and Video Controls: Immerse yourself in superior audiovisual experiences.',
          image: theater,
        },
        {
          icon: <GrVmMaintenance style={{ height: '50px', width: '50px' }} />,
          title: 'Maintenance',
          description:
            'Reliability: Trust our thorough maintenance services to keep your solar system operating reliably.',
          image: project5,
        },
        {
          icon: <MdOutlineSupportAgent style={{ height: '50px', width: '50px' }} />,
          title: 'Consult Us',
          description:
            'Expert Guidance: Receive personalized advice from our knowledgeable solar energy experts.',
          image: project6,
        },
      ];
  return (
    ...
    <div className="carousel-inner">
      ...
      <img src={cor1}  height="550px" width="100%" />
         
      </div>
      <div className="carousel-item">
      <img src={gallery1}  height="550px" width="100%" />
         
      </div>
      <div className="carousel-item active">
      <img src={gallery2}  height="550px" width="100%" />
    ...
    {/* <!-- About End --> */}
    {/* <!-- Service Start --> */}
    <div className="container-xx l py-5">
