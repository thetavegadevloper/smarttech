...
function Home() {
  ...
  return (
    ...
    <h1 className="custom-tagline1 " > " WELCOME TO SMART TECH SOLUTIONS"</h1>
</div>
 {/* services start  */} 
 <div className=' text-warning text-start mt-5' > 
 <h4 className="text-center  mt-5 mb-4"> Our Services</h4>
    ...
    <div className="container">
      ...
      <div className="row justify-content-center">
        ...
        <div className="col-md-4">
          <a href="project" className="project-container">
            <img src="project4.jpeg" alt="project 3" className="project-image"/>
          </a>
        </div>
        <div className="col-md-4">
          <a href="project" className="project-container">
            <img src="project5.jpg" alt="project 3" className="project-image"/>
          </a>
        </div>
        <div className="col-md-4">
          <a href="project6.jpg" className="project-container">
            <img src="pr3.jpg" alt="project 3" className="project-image"/>
          </a>
        </div>
      </div>
