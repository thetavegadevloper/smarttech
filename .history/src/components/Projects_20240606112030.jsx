...
<section class="testimonial-section">
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          <h2 class=" text-center text-success">What Our Clients Say</h2>
      ...
      <div class="row mt-5">
        ...
        <div class="col-md-4">
          <div class="testimonial">
            ...
            <blockquote>
              <p>"Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et qu inventore veritatis et qu"</p>
