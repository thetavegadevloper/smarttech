        ...
        <div class="testimonial-container">
          <div class="testimonial-slide">
            <div class="testimonial">
              <img src="Aboutus.jpg" alt="Client 1" class="client-image"/>
              <p class="quote">"Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer nec odio. Praesent libero. Sed cursus ante dapibus diam."</p>
              <p class="author">- John Doe</p>
            </div>
            <div class="testimonial">
              <img src="client2.jpg" alt="Client 2" class="client-image"/>
              <p class="quote">"Vestibulum quis quam ut magna consequat faucibus. Pellentesque lorem felis, ultricies a bibendum id."</p>
