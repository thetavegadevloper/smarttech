  ...
  return (
    ...
    <div className="carousel-inner">
      ...
      <img src={cor1}  height="550px" width="100%" />
        ...
        <h1> Powering Homes With Solar Panels </h1>
    ...
    <div className="carousel-inner">
      <div className="carousel-item active" data-bs-interval="10000">
        ...
        <div className="carousel-caption d-none d-md-block">
          ...
          <p className="text-white " style={{}}>Some representative placeholder content for the first slide.</p>
        </div>
      </div>
                ...
                <div className="col-lg-6 feature-text py-5 wow fadeIn" data-wow-delay="0.1s">
                    <div className="p-lg-5 ps-lg-0">
                        ...
                        <div className="row g-4">
                            <div className="col-6">
                                <div className="d-flex align-items-center">
                                    <div className="btn-lg-square bg-dark rounded-circle">
                                        <i className="fa fa-check text-white"></i>
                                    </div>
                                    <div className="ms-4">
                                        <p className="mb-0">Quality</p>
