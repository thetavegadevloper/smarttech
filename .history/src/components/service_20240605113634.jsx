        ...
        <div class="custom-service-container">
          <a href="#" class="custom-service-link">
            ...
            <ul class="custom-service-points">
              <li>Design and installation : Tailored Solutions for residential , commercial, and industrai consumers. </li>
      ...
      <div class="col-md-12">
        <div class="custom-service-container">
          <a href="#" class="custom-service-link">
            ...
            <h3 class="custom-service-title">Custom Service 1</h3>
            <ul class="custom-service-points">
              <li>Custom Point 1</li>
              <li>Custom Point 2</li>
              <li>Custom Point 3</li>
            </ul>
          </a>
        </div>
      </div>
