...
<div class="container">
  ...
  <div class="row testimonial-cards">
    <div class="col-md-4">
      <div class="card">
        <img class="card-img-top" src="Aboutus.jpg" alt="John Doe"/>
        <div class="card-body">
    ...
    <div class="col-md-4">
      <div class="card">
        <img class="card-img-top" src="Aboutus.jpg" alt="Jane Smith"/>
        <div class="card-body">
    ...
    <div class="col-md-4">
      <div class="card">
        <img class="card-img-top" src="Aboutus.jpg" alt="David Johnson"/>
        <div class="card-body">
