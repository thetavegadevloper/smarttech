...
function Home() {
  ...
  return (
    ...
    <div className="container-fluid">
      <a className="navbar-brand me-auto" href="#"><img src="logo.png" alt="" height="60px"/></a>
      ...
      <div className="offcanvas offcanvas-end" tabIndex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
        ...
        <div className="offcanvas-body">
          <ul className="navbar-nav justify-content-center flex-grow-1 pe-3">
            ...
            <li className="nav-item">
              <a className="nav-link  mx-lg-2 active" href="#">About</a>
            </li>
            <li className="nav-item">
            ...
            <li className="nav-item">
              <a className="nav-link  mx-lg-2 active" href="#">Contact</a>
            </li>
      ...
      <a href="#" className="login-button">Get a Quote</a>
