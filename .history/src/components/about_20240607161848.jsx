        ...
        <div className="row">
          <div className="col-md-4">
            <div className="card rounded-container ">
              ...
              <div className="card-body text-center">
                <h5 className="card-title fw-bold text-black">SUSTAINABILITY</h5>
          ...
          <div className="col-md-4">
            <div className="card rounded-container">
              ...
              <br/>
              <div className="card-body text-center">
                <h5 className="card-title fw-bold text-black">QUALITY</h5>
          ...
          <div className="col-md-4">
            <div className="card rounded-container">
              ...
              <br/>
              <div className="card-body text-center">
                <h5 className="card-title fw-bold text-black"> CUSTOMER SATISFACTION</h5>
