...
function About() {
  ...
  <div class="container-fluid">
      <div class="container">
        <h3 class="text-center text-success"> Our Values</h3>
        <br/>
        <br/>
        <div class="row">
          <div class="col-md-4">
          ...
          <div class="col-md-4">
            <div class="card rounded-container">
              <img src="stamp.jpg" class="card-img-top" alt="Image 2"/>
              <br/>
              <div class="card-body text-center">
          ...
          <div class="col-md-4">
            <div class="card rounded-container">
              <img src="third.jpg" class="card-img-top" alt="Image 3"/>
              <br/>
              <div class="card-body text-center">
                <h5 class="card-title"> CUSTOMER SATISFACTION</h5>
                <p class="card-text text-gray"> your Satisfaction is our priority, driving us to deliver exceptional results</p>
              </div>
            </div>
          </div>
        </div>
