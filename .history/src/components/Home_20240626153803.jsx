  ...
  return (
            ...
            <div className="row g-0 mx-lg-0">
                ...
                <div className="col-lg-6 about-text py-5 wow fadeIn" data-wow-delay="0.5s">
                    <div className="p-lg-5 pe-lg-0">
                        ...
                        <p style={{textAlign : "justify"}}>Smart Tech Solutions is a leading provider of technology solutions specializing in renewable energy and smart automation. with team of experienced professionals and a passion for innovation , we strive to deliver top-notch services tailored to our clients needs</p>
                ...
                <div className="col-md-6 col-lg-4 wow fadeInUp" data-aos="fade-up"  data-aos-duration="1000">
                    <div className="service-item  overflow-hidden">
                        ...
                        <div className="position-relative p-4 pt-0">
                            ...
                            <p style={{textAlign : "justify"}}> we specialize in providing cutting-edge solar rooftop solutions tailored to meet the energy needs of residential, commercial, and industrial properties.</p>
                ...
                <div className="col-md-6 col-lg-4 wow fadeInUp" data-aos="fade-up" data-aos-duration="2000">
                    <div className="service-item  overflow-hidden">
                        ...
                        <div className="position-relative p-4 pt-0">
                            ...
                            <p style={{textAlign : "justify"}}>we specialize in designing, developing, and operating state-of-the-art solar power plants to meet the growing demand for clean and sustainable energy.  </p>
                            <Link className="small fw-medium text-warning" to="/service">Read More<i className="fa fa-arrow-right ms-2"></i></Link>
                        </div>
                    </div>
                </div>
                <div className="col-md-6 col-lg-4 wow fadeInUp" data-aos="fade-up" data-aos-duration="3000">
                    <div className="service-item  overflow-hidden">
                        ...
                        <div className="position-relative p-4 pt-0">
                            ...
                            <p style={{textAlign : "justify"}}>We specialize in transforming residences into smart, sophisticated spaces where convenience, comfort, and control are at your fingertips. </p>
                            <Link className="small fw-medium  text-warning" to="/service" >Read More<i className="fa fa-arrow-right ms-2"></i></Link>
                        </div>
                    </div>
                </div>
                <div className="col-md-6 col-lg-4 wow fadeInUp" data-aos="fade-up" data-aos-duration="1000">
                    <div className="service-item  overflow-hidden">
                        ...
                        <div className="position-relative p-4 pt-0">
                            ...
                            <p style={{textAlign : "justify"}}>Our home theaters are custom-designed to meet your unique preferences and lifestyle. Whether you envision a cozy media room for family movie nights. </p>
                            <Link className="small fw-medium text-warning" to="/service">Read More<i className="fa fa-arrow-right ms-2"></i></Link>
                        </div>
                    </div>
                </div>
                <div className="col-md-6 col-lg-4 wow fadeInUp" data-aos="fade-up"  data-aos-duration="2000">
                    <div className="service-item  overflow-hidden">
                        ...
                        <div className="position-relative p-4 pt-0">
                            ...
                            <p style={{textAlign : "justify"}}> Our comprehensive solar maintenance services ensure that your investment continues to deliver optimal energy savings and environmental benefits year after year.</p>
                ...
                <div className="col-md-6 col-lg-4 wow fadeInUp" data-aos="fade-up" data-aos-duration="3000">
                    <div className="service-item  overflow-hidden">
                        ...
                        <div className="position-relative p-4 pt-0">
                            ...
                            <p style={{textAlign : "justify"}}>we specialize in providing expert solar consultation services to help you navigate the transition to renewable energy with confidence.  </p>
                            <Link className="small fw-medium text-warning"  to="/contact">Read More<i className="fa fa-arrow-right ms-2"></i></Link>
                        </div>
                    </div>
                </div>
            ...
            <div className="row g-0 mx-lg-0">
                <div className="col-lg-6 feature-text py-5 wow fadeIn" data-wow-delay="0.1s">
                    <div className="p-lg-5 ps-lg-0">
                        ...
                        <p className="mb-4 pb-2" style={{textAlign : "justify"}}> Whether you’re looking to reduce your carbon footprint, lower energy costs, or gain energy independence, we have the expertise to deliver tailored solar solutions that meet your needs.</p>
                        <div className="row g-4">
                            <div className="col-6">
    ...
    <div className="faq-container ">
        ...
        <div className="faq-item">
          ...
          <div className="faq-content">
            <p style={{textAlign : "justify"}}>The benefits of solar energy include: reduction in electricity bills, long-term cost savings, reduced carbon footprint, combating climate change, increased property value, and energy independence.</p>
          </div>
        </div>
        ...
        <div className="faq-item">
          ...
          <div className="faq-content">
            <p style={{textAlign : "justify"}}>Several factors affect the efficiency of solar panels, including: the angle and orientation of the panels relative to the sun, shading from trees or buildings, weather conditions such as cloud cover and temperature, and the quality and condition of the panels and associated equipment.</p>
          </div>
        </div>
        <div className="faq-item">
          ...
          <div className="faq-content">
            <p style={{textAlign : "justify"}}>Solar panels can still generate electricity on cloudy days, although their output is reduced. During the night, your home or business will use electricity from the grid unless you have a solar battery storage system to store excess energy generated during the day.</p>
          </div>
        </div>
