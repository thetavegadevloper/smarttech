...
function About() {
  return (
    ...
    <div className="custom-tagline " > <div className="col-md-12 text-center">
            ...
            <a href="home">  <button type="button" className="btn btn-warning text-white">Explore More </button></a>
          </div>  </div>
  ...
  <div className="container-fluid">
      <div className="container">
        ...
        <div className="row">
          <div className="col-md-4">
            <div className="card rounded-container ">
              ...
              <div className="card-body text-center">
                <h5 className="card-title fw-bold text-success">SUSTAINABILITY</h5>
          ...
          <div className="col-md-4">
            <div className="card rounded-container">
              <img src="award_ribbon_check_mark_with_stars_gradient_style.jpg" className="card-img-top" alt="Image 2"/>
              <br/>
              <div className="card-body text-center">
                <h5 className="card-title fw-bold text-success">QUALITY</h5>
          ...
          <div className="col-md-4">
            <div className="card rounded-container">
              <img src=" 5374800.jpg" className="card-img-top" alt="Image 3"/>
              <br/>
              <div className="card-body text-center">
                <h5 className="card-title fw-bold text-success"> CUSTOMER SATISFACTION</h5>
