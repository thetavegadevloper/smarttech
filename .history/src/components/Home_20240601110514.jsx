...
function Home() {
 ...
 <h1 class="heading fadeIn">Our Services</h1>
    ...
    <div class="service-container">
        <div class="service">
            <img src="service1" alt="Service 1" height="250px"/>
        ...
        <div class="service">
            <img src="service2" alt="Service 2"  height="250px"/>
        ...
        <div class="service">
            <img src="service3" alt="Service 2" height="250px"/>
        ...
        <div class="service">
            <img src="service4" alt="Service 2" height="250px"/>
            <h3>Home Theaters</h3>
            <br/>
            <div class="para">   
                <ul>
