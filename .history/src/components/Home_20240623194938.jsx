  ...
  return (
    ...
    <nav class="custom-navbar navbar navbar-expand-lg sticky-top">
        <div class="container-fluid">
            ...
            <button class="navbar-toggler custom-navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarNav" aria-controls="navbarNav" aria-label="Toggle navigation">
            ...
            <a href="contact.html" class="custom-login-button text-white d-lg-inline-block">Get a Quote</a>
        </div>
    </nav>
