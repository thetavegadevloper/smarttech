    ...
    <section class="custom-services-section">
        <div class="container">
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="custom-service-container fadeIn">
                <img src="service5.jpg" alt="Service 1" class="custom-service-image"/>
                <div class="custom-service-text">
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="custom-service-container fadeIn">
                <img src="service3.jpg" alt="Service 1" class="custom-service-image"/>
                <div class="custom-service-text">
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="custom-service-container fadeIn">
                <img src="service4.jpg" alt="Service 1" class="custom-service-image"/>
                <div class="custom-service-text">
