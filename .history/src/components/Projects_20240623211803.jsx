        ...
        <div className="container-fluid">
            ...
            <div className="collapse navbar-collapse justify-content-center" id="navbarNav">
                <ul className="navbar-nav">
                    ...
                    <li className="nav-item">
                        <a className="nav-link active" href="project.html">Projects</a>
                    </li>
                    <li className="nav-item">
            ...
            <a href="contact.html" className="custom-login-button text-white d-lg-inline-block">Get a Quote</a>
        </div>
    </nav>
  ...
  <div className="container-xxl py-5">
      ...
      <div className="container">
        ...
        <div className="row g-4 portfolio-container wow fadeInUp" data-wow-delay="0.5s">
          {/* Replace href with onClick to trigger lightbox */}
          <div className="col-lg-6 col-md-6 portfolio-item first" data-aos="fade-up" data-aos-duration="3000">
            <div className="portfolio-img  overflow-hidden">
              <img className="img-fluid" src={project1} alt="" onClick={() => openLightbox(project1)} />
              <div className="portfolio-btn">
                <a className="btn btn-lg-square btn-outline-light rounded-circle mx-1" onClick={() => openLightbox(project1)}><i className="fa fa-eye"></i></a>
              </div>
            </div>
            {/* Project details */}
          </div>
      ...
      {/* Lightbox */}
      <div className={`lightbox ${lightbox.isOpen ? 'active' : ''}`} onClick={closeLightbox}>
        <img src={lightbox.imageUrl} alt="Project" style={{ minWidth: '300px', minHeight: '300px', background: 'none' }} />
      </div>
    </div>
  {/* <!-- Projects End --> */}
