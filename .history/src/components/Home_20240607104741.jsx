...
function Home() {
  return (
    ...
    <img src="homehead5.avif" alt="Image"/>
    <div className="custom-tagline " > <h5> "Switch to Solar: Where Clean Energy Meets Cost Efficiency!"</h5></div>
</div>
 {/* services start  */} 
  ...
  <div className="container   " id="solcal">
        <div >
            <div className="card-body">
                <h2 className="text-center mb-5 text-success">Solar Calculator</h2>
                <form id="solar-form">
                    ...
                    <button type="submit" className="btn btn-success   b1">Calculate</button>
                </form>
