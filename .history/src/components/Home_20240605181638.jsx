            ...
            <form id="solar-form">
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" id="location" name="location" class="custm-form-control" placeholder="Enter your location" required/>
                    </div>
                    <div class="form-group col-md-6">
                        <label  htmlFor="system-size">System Size (kW):</label>
                        <input type="number" id="system-size" name="system-size" class="custm-form-control" min="1" max="100" required/>
                    </div>
                </div>
                <div class="form-row">
                    <div class="form-group col-md-6">
                        <label  htmlFor="energy-consumption">Energy Consumption (kWh/month):</label>
                        <input type="number" id="energy-consumption" name="energy-consumption" class="custm-form-control" min="1" max="10000" required/>
                    </div>
                    <div class="form-group col-md-6">
                        <label  htmlFor="roof-size">Roof Size (sqft):</label>
                        <input type="number" id="roof-size" name="roof-size" class="custm-form-control" min="100" max="10000" required/>
                    </div>
                </div>
                <div class="form-row">
                    <div class="form-group col-md-6">
                        <label  htmlFor="roof-orientation">Roof Orientation:</label>
                        <select id="roof-orientation" name="roof-orientation" class="custm-form-control" required>
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <select id="shading" name="shading" class="custm-form-control" required>
                ...
                <button type="submit" class="btn btn-primary custm-btn">Calculate</button>
            </form>
