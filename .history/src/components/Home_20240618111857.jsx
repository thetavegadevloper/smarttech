...
<body>
    ...
    {/* <!-- About Start --> */}
    <div className="container-fluid  overflow-hidden my-5 px-lg-0" style="background-color: rgb(247, 247, 247);">
        <div className="container about px-lg-0">
            <div className="row g-0 mx-lg-0">
                <div className="col-lg-6 ps-lg-0 wow fadeIn" data-wow-delay="0.1s" style="min-height: 400px;">
                    <div className="position-relative h-100">
                        <img className="position-absolute img-fluid w-100 h-100" src="servicehead1.jpg" style="object-fit: cover;" alt=""/>
                    </div>
                </div>
    ...
    <div className="container-xxl py-5">
        <div className="container">
            <div className="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px;">
                <h6 className="text-warning">Our Services</h6>
        ...
        <div className="container feature px-lg-0">
            <div className="row g-0 mx-lg-0">
                ...
                <div className="col-lg-6 pe-lg-0 wow fadeIn" data-wow-delay="0.5s" style="min-height: 400px;">
                    <div className="position-relative h-100">
                        <img className="position-absolute img-fluid w-100 h-100" src="project4.jpeg" style="object-fit: cover;" alt=""/>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div className="row g-4 portfolio-container wow fadeInUp" data-wow-delay="0.5s">
                <div className="col-lg-4 col-md-6 portfolio-item first">
                    <div className="portfolio-img  overflow-hidden">
                        <img className="img-fluid" src="pr1.jpg" alt=""/>
                ...
                <div className="col-lg-4 col-md-6 portfolio-item second">
                    <div className="portfolio-img  overflow-hidden">
                        <img className="img-fluid" src="pr3.jpg" alt=""/>
                        <div className="portfolio-btn">
                ...
                <div className="col-lg-4 col-md-6 portfolio-item third">
                    <div className="portfolio-img  overflow-hidden">
                        <img className="img-fluid" src="project6.jpeg" alt=""/>
                        <div className="portfolio-btn">
