  ...
  return (
    ...
    <div className='content'> 
     ...
     <div className='service-container fluid bg-white'>
      ...
      <p className='text-center'> we specialize in empowering homeowners and businesses with cutting-edge rooftop solar solutions. With our expertise in renewable energy, we transform rooftops into power-generating assets, paving the way for a sustainable future.</p>
