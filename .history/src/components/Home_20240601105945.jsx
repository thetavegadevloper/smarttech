...
function Home() {
 ...
 {/* services start  */} 
 <h1 class="heading fadeIn">Our Services</h1>
    
    <div class="service-container">
        <div class="service">
            <img src="RTS.jpg" alt="Service 1" height="250px"/>
            <h3 >Rooftop Solutions</h3>
            <br/>
            <div class="para">   
                <ul>
                    <li>Design and Installation : Tailored Solutions for Residential,Commercial,and industrail consumers. </li>
                    <li> Business Models : Choose between OPEX ( Operating Expense) and Capex (Capital Expense ) models.</li>
                    <li> Benefits : Cost savings ,energy independence, and environment impact. </li>
                </ul>
            </div>
        </div>
        <div class="service">
            <img src="solarplant.jpg" alt="Service 2"  height="250px"/>
        ...
        <div class="service">
            <img src="Automation.jpg" alt="Service 2" height="250px"/>
        ...
        <div class="service">
            <img src="photo3.jpg" alt="Service 2" height="250px"/>
            <h3>Home Theaters</h3>
            <br/>
            <div class="para">   
                <ul>
