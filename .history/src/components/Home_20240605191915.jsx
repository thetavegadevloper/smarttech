...
function Home() {
 ...
 {/* services start  */} 
 <div className='service-head text-black'> 
 <h4 > OUR SERVICES</h4>
    ...
    <div className="service-container">
        ...
        <div className="service">
            ...
            <button type="button" className="btn btn-outline-black">Read More </button>
        </div>
        <div className="service">
    ...
    <div className="container">
      <div className="row">
        <div className="col-md-12 text-center">
          <h2 className="section-title mb-5  mt-5 text-primary">Checkout Our  Latest Projects </h2>
        </div>
      </div>
