  ...
  return (
    ...
    <div className="container-xxl py-5">
        <div className="container">
            <div className="text-center mx-auto mb-5 wow fadeInUp" data-aos-duration="0.3s" style={{maxWidth: "600px"}}>
                <h6 className="text-warning " data-aos="fade-up" >Our Services</h6>
                <h1 className="mb-4" data-aos="fade-up">We Are Pioneers In The World Of Renewable Energy</h1>
            </div>
