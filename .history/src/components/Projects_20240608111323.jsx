...
{/* header end  */}
    ...
    <div className="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style={{maxWidth: "600px"}}>
        <h4 className="text-warning mt-5">Our Projects</h4>
...
{/* testimonial start  */} 
<div class="container">
  <h2 class="testimonial-heading text-warning ">Client Testimonials</h2>
  ...
  <div class="row testimonial-cards">
    ...
    <div class="col-md-4">
      <div class="card">
        <img class="card-img-top" src="people3.jpg" alt="David Johnson"/>
        <div class="card-body">
    ...
    <div className='container text-center text-md-left'>
      ...
      <div className='row align-items-center'>
        <div className='col-md-7 col-lg-8'>
          <p>Copyright @2024 All Rights Reserved by <a href='#' style={{ textDecoration: 'none' }}><strong className='text-warning'>The Providers</strong></a></p>
        </div>
