                ...
                <form id="solar-form">
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="number" id="system-size" name="system-size" class="form-control" min="1" max="100" required/>
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            <label for="energy-consumption">Energy Consumption (kWh/month):</label>
                            <input type="number" id="energy-consumption" name="energy-consumption" class="form-control" min="1" max="10000" required/>
                        </div>
                        <div class="form-group col-md-6">
                            <label for="roof-size">Roof Size (sqft):</label>
                            <input type="number" id="roof-size" name="roof-size" class="form-control" min="100" max="10000" required/>
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            <label for="roof-orientation">Roof Orientation:</label>
                            <select id="roof-orientation" name="roof-orientation" class="form-control" required>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <select id="shading" name="shading" class="form-control" required>
                    ...
                    <button type="submit" class="btn btn-primary   b1">Calculate</button>
                </form>
  ...
  <div className="container mt-5">
        <div className="card">
            <div className="card-body">
                <h1 className="text-center mb-4">Solar Calculator</h1>
                <form id="solar-form" class="calo">
                    <div className="form-row">
                        <div className="form-group col-md-6">
                            <label for="location">Location:</label>
                            <input type="text" id="location" name="location" className="form-control calo-input" placeholder="Enter your location" required/>
                        </div>
                        <div className="form-group col-md-6">
                            <label for="system-size">System Size (kW):</label>
                            <input type="number" id="system-size" name="system-size" className="form-control calo-input" min="1" max="100" required/>
                        </div>
                    </div>
                    <div className="form-row">
                        <div className="form-group col-md-6">
                            <label for="energy-consumption">Energy Consumption (kWh/month):</label>
                            <input type="number" id="energy-consumption" name="energy-consumption" className="form-control calo-input" min="1" max="10000" required/>
                        </div>
                        <div className="form-group col-md-6">
                            <label for="roof-size">Roof Size (sqft):</label>
                            <input type="number" id="roof-size" name="roof-size" className="form-control calo-input" min="100" max="10000" required/>
                        </div>
                    </div>
                    <div className="form-row">
                        <div className="form-group col-md-6">
                            <label for="roof-orientation">Roof Orientation:</label>
                            <select id="roof-orientation" name="roof-orientation" className="form-control calo-select" required>
                                <option value="south">South</option>
                                <option value="north">North</option>
                                <option value="east">East</option>
                                <option value="west">West</option>
                        ...
                        <div className="form-group col-md-6">
                            <label for="shading">Shading:</label>
                            <select id="shading" name="shading" className="form-control calo-select" required>
                                <option value="none">None</option>
                                <option value="light">Light</option>
                                <option value="heavy">Heavy</option>
                            </select>
                    ...
                    <button type="submit" className="btn btn-primary b1">Calculate</button>
                </form>
                <div className="results mt-4 calo">
                    <h3>Results:</h3>
                    <p id="estimated-energy-output"></p>
                    <p id="estimated-savings"></p>
                    <p id="payback-period"></p>
