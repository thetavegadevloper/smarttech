    ...
    <div className="container">
      ...
      <div className="row">
        <div className="col-md-12">
          <div className="service-container">
            <a href="#" className="service-link">
              <img src="service1.jpg" alt="Service 2" className="service-image"/>
      ...
      <div className="row">
        <div className="col-md-12">
          <div className="service-container">
            <a href="#" className="service-link">
              <img src="service1.jpg" alt="Service 3" className="service-image"/>
      ...
      <div className="row">
        <div className="col-md-12">
          <div className="service-container">
            <a href="#" className="service-link">
              <img src="service1.jpg" alt="Service 4" className="service-image"/>
