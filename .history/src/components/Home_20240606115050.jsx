...
function Home() {
 ...
 <h4 > Our Services</h4>
  ...
  {/* project end  */}
  {/* solar calculator */}
  <div class="container mt-5 calocon">
        <div class="card">
            <div class="card-body">
                ...
                <form id="solar-form" class="calo">
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" id="location" name="location" class="form-control calo-input" placeholder="Enter your location" required/>
                        </div>
                        <div class="form-group col-md-6">
                            <label for="system-size">System Size (kW):</label>
                            <input type="number" id="system-size" name="system-size" class="form-control calo-input" min="1" max="100" required/>
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            <label for="energy-consumption">Energy Consumption (kWh/month):</label>
                            <input type="number" id="energy-consumption" name="energy-consumption" class="form-control calo-input" min="1" max="10000" required/>
                        </div>
                        <div class="form-group col-md-6">
                            <label for="roof-size">Roof Size (sqft):</label>
                            <input type="number" id="roof-size" name="roof-size" class="form-control calo-input" min="100" max="10000" required/>
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            <label for="roof-orientation">Roof Orientation:</label>
                            <select id="roof-orientation" name="roof-orientation" class="form-control calo-select" required>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <select id="shading" name="shading" class="form-control calo-select" required>
