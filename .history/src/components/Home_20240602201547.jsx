...
function Home() {
 ...
 <div className='hero'>
    ...
    <div className='content'> 
        ...
        <p className='text-center'> At Smart Tech Solutions, we are committed to bringing innovative technology solutions to homes and businesses, empowering you to embrace the future with sustainable energy and advanced automation. </p>
