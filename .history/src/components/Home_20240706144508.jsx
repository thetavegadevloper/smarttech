...
function Home() {
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src={header1} class="d-block w-100" alt="Slide 1"/>
      {/* <div class="carousel-caption d-none d-md-block">
        <div class="caption-content">
          <h4>Slide 1 Subtitle</h4>
          <h1>Slide 1 Title</h1>
    ...
    <div class="carousel-item">
      <img src={header2} class="d-block w-100" alt="Slide 2"/>
      {/* <div class="carousel-caption d-none d-md-block">
        <div class="caption-content">
          <h4>Slide 2 Subtitle</h4>
          <h1>Slide 2 Title</h1>
          <a href="#" class="btn btn-primary">Learn More</a>
        </div>
      </div> */}
    ...
    <div class="carousel-item">
      <img src={header3} class="d-block w-100" alt="Slide 3"/>
      {/* <div class="carousel-caption d-none d-md-block">
        <div class="caption-content">
          <h4>Slide 3 Subtitle</h4>
          <h1>Slide 3 Title</h1>
          <a href="#" class="btn btn-primary">Learn More</a>
        </div>
      </div> */}
