          ...
          <div className='bg-dark text-white pt-5 pb-4'>
              <div className='container text-center text-md-left'>
               <div className='row text-center text-md-left'>
                  ...
                  <h5 className='text-uppercase mb-4  font-weight-bold text-warning '></h5> 
                   <p> 
                    <i className='fas fa-home mr-3'>New York ,NY 2023, US</i>
                   </p>
                   <p> 
                    <i className='fas fa-envelope mr-3'>New York ,NY 2023, US</i>
                   </p>
                   <p> 
                    <i className='fas fa-phone mr-3'>New York ,NY 2023, US</i>
                   </p>
                   <p> 
                    <i className='fas fa-print mr-3'>New York ,NY 2023, US</i>
                   </p>
                  </div>
              ...
              <div className='row align-items-center '> 
                 <div className='col-md-7  col-lg-8'>
                   ...
                   <a href='#' style={"text-decoration: none;"}> <strong className='text-warning'> The Providers </strong></a>
                   </p>
                 </div>
                 ...
                 <div className='text-center text-md-right '>
                    <ul className='list-unstyled list-inline '> 
                       ...
                       <a href='#' className='btn-floating btn-sm text-white ' style={"font-size: 23px;"}> <i className='fab  fa-facebook'></i></a>
                       </li>
                       <li className='list-inline-item'>
                       <a href='#' className='btn-floating btn-sm text-white ' style={"font-size: 23px;"}> <i className='fab  fa-twitter'></i></a>
                       </li>
                       <li className='list-inline-item'>
                       <a href='#' className='btn-floating btn-sm text-white ' style={"font-size: 23px;"}> <i className='fab  fa-google-plus'></i></a>
                       </li>
                       <li className='list-inline-item'>
                       <a href='#' className='btn-floating btn-sm text-white ' style={"font-size: 23px;"}> <i className='fab  fa-linkedin-in'></i></a>
                       </li>
                       <li className='list-inline-item'>
                       <a href='#' className='btn-floating btn-sm text-white ' style={"font-size: 23px;"}> <i className='fab  fa-youtube'></i></a>
                       </li>
                    </ul>
