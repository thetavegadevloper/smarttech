        ...
        <div class="custom-service-container">
          <a href="#" class="custom-service-link">
            ...
            <ul class="custom-service-points">
              <li><h5>Design and installation : </h5> <p> Tailored Solutions for residential , commercial, and industrai consumers. </p></li>
              <li><h5> Business Models :</h5> <p>  Choose between OPEX ( Operating Expense) and Capex (Capital Expense) Models. </p></li>
              <li><h5> Benefits :</h5><p>  Cost savings , energy independence , and environmental impact.</p></li>
            </ul>
          </a>
        </div>
      </div>
