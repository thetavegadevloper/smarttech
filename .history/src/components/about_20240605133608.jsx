...
function About() {
  ...
  {/* values start  */}
  <div class="heading">
    <h1>Three-Part Container</h1>
  </div>
  <div class="container-fluid">
    <div class="row">
      <div class="col-md-4">
        <div class="part">
          <img src="service1.jpg" alt="Left Image"/>
          <h2>Left Part</h2>
          <p>This is some information about the left part.</p>
        </div>
      </div>
      <div class="col-md-4">
        <div class="part">
          <img src="service1.jpg" alt="Middle Image"/>
          <h2>Middle Part</h2>
          <p>This is some information about the middle part.</p>
        </div>
      </div>
      <div class="col-md-4">
        <div class="part">
          <img src="service1.jpg" alt="Right Image"/>
          <h2>Right Part</h2>
          <p>This is some information about the right part.</p>
        </div>
      </div>
    </div>
  </div>
