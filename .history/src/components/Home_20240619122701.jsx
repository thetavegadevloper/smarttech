    ...
    <div className="container-xxl py-5">
        <div className="container">
            ...
            <div className="row g-4">
                <div className="col-md-6 col-lg-4 wow fadeInUp" data-aos="fade-up"  data-aos-duration="1200">
                ...
                <div className="col-md-6 col-lg-4 wow fadeInUp" data-aos="fade-up" data-aos-duration="1500">
                    <div className="service-item  overflow-hidden">
                ...
                <div className="col-md-6 col-lg-4 wow fadeInUp" data-aos="fade-up" data-aos-duration="1800">
                    <div className="service-item  overflow-hidden">
                ...
                <div className="col-md-6 col-lg-4 wow fadeInUp" data-aos="fade-up" data-aos-duration="2100">
                    <div className="service-item  overflow-hidden">
