...
function Home() {
        ...
        <div className="container-fluid">
            ...
            <div className="collapse navbar-collapse justify-content-center" id="navbarNav">
                <ul className="navbar-nav">
                    ...
                    <li className="nav-item">
                        <a className="nav-link"  href="#section3">Services</a>
                    </li>
  ...
  <div class="carousel-slide">
    <img src={header1} alt="Slide 1" />
    <div class="carousel-caption">
      <h2>Welcome to Solar Power Solutions</h2>
      <p>Discover sustainable energy solutions for a brighter future.</p>
    </div>
  </div>
  <div class="carousel-slide">
    <img src={header2} alt="Slide 2" />
    <div class="carousel-caption">
      <h2>Efficient Solar Panels</h2>
      <p>Powerful solar panels designed to maximize energy efficiency.</p>
    </div>
  </div>
  <div class="carousel-slide">
    <img src={header3} alt="Slide 3" />
    <div class="carousel-caption">
      <h2>Join the Solar Revolution</h2>
      <p>Transforming how we harness renewable energy for a sustainable future.</p>
    </div>
  </div>
</div>
        ...
        <div class="row">
          <div class="col-md-4">
            <div class="card rounded-container "> 
              ...
              <div class="card-body text-center">
                <h5 class="card-title text-warning">SUSTAINABILITY</h5>
          ...
          <div class="col-md-4">
            <div class="card rounded-container">
              ...
              <br/>
              <div class="card-body text-center">
                <h5 class="card-title text-warning">QUALITY</h5>
    ...
    <div > 
    <div className="text-center mx-auto mt-5 mb-2 wow fadeInUp" data-wow-delay="0.1s" style={{maxWidth: "600px"}}>
                <h4 className="text-warning " data-aos="fade-up"  data-aos-duration="1000" id="section3">Our Services</h4>
...
<div class="container py-5">
  <div class="row">
    <div class="col-md-6">
      <div class="quote-form bg-dark text-white p-4 rounded">
        <h2 class="mb-4">Get a Quote</h2>
        <form id="quoteForm" method="POST" action="submit_quote.php">
          <div class="mb-3">
    ...
    <div class="col-md-6">         
      <div class="map-container">
        ...
        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3752.1540562823006!2d75.34763437420601!3d19.875715726382598!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bdba3eccf8ca457%3A0x5dbfa2b513834344!2sSeven%20hill!5e0!3m2!1sen!2sin!4v1719472188387!5m2!1sen!2sin"  width="100%" height="630" style={{border:"0"}} allowfullscreen="" loading="lazy"></iframe>
      </div>
    </div>
  </div>
</div>
