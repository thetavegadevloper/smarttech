  ...
  return (
    ...
    <nav className="custom-navbar navbar navbar-expand-lg sticky-top">
        <div className="container-fluid">
            <Link className="navbar-brand me-auto" to="/"><div className="d-flex"> <img src={logo} alt="Logo" height="60px"/> 
            <div className="name"> <span>Smart Tech</span> <span> Solutions</span> </div></div></Link>
