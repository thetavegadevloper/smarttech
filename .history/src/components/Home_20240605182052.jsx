            ...
            <form id="solar-form">
                <div className="form-row">
                    <div className="form-group col-md-6">
                        ...
                        <input type="text" id="location" name="location" className="custm-form-control" placeholder="Enter your location" required/>
                    </div>
                    <div className="form-group col-md-6">
                        <label  htmlFor="system-size">System Size (kW):</label>
                        <input type="number" id="system-size" name="system-size" className="custm-form-control" min="1" max="100" required/>
                    </div>
                </div>
                <div className="form-row">
                    <div className="form-group col-md-6">
                        <label  htmlFor="energy-consumption">Energy Consumption (kWh/month):</label>
                        <input type="number" id="energy-consumption" name="energy-consumption" className="custm-form-control" min="1" max="10000" required/>
                    </div>
                    <div className="form-group col-md-6">
                        <label  htmlFor="roof-size">Roof Size (sqft):</label>
                        <input type="number" id="roof-size" name="roof-size" className="custm-form-control" min="100" max="10000" required/>
                    </div>
                </div>
                <div className="form-row">
                    <div className="form-group col-md-6">
                        <label  htmlFor="roof-orientation">Roof Orientation:</label>
                        <select id="roof-orientation" name="roof-orientation" className="custm-form-control" required>
                    ...
                    <div className="form-group col-md-6">
                        ...
                        <select id="shading" name="shading" className="custm-form-control" required>
                ...
                <button type="submit" className="btn btn-primary custm-btn">Calculate</button>
            </form>
