            ...
            <form id="solar-form">
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" id="location" name="location" class="custom-input-style" placeholder="Enter your location" required/>
                    </div>
                    <div class="form-group col-md-6">
                        <label  htmlFor="system-size">System Size (kW):</label>
                        <input type="number" id="system-size" name="system-size" class="custom-input-style" min="1" max="100" required/>
                    </div>
                </div>
                <div class="form-row">
                    <div class="form-group col-md-6">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="number" id="roof-size" name="roof-size" class="custom-input-style" min="100" max="10000" required/>
                    </div>
                </div>
                <div class="form-row">
                    <div class="form-group col-md-6">
                        <label  htmlFor="roof-orientation">Roof Orientation:</label>
                        <select id="roof-orientation" name="roof-orientation" class="custom-select-style" required>
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <select id="shading" name="shading" class="custom-select-style" required>
                ...
                <button type="submit" class="btn btn-primary custom-button-style">Calculate</button>
            </form>
