    ...
    <div className="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style={{maxWidth: "600px"}}>
     ...
     <div className="container-fluid py-5">
      <Tabs
        ...
        justify
      >
        <Tab eventKey="home" title="RoofTop Solar Solutions">
          <div className="row">
        ...
        <Tab eventKey="contact" title="Home Theatres">
          <div className="row">
            <div className="col-md-6 col-lg-4 mb-4">
              <div className="service-item">
                <img className="img-fluid" src={theater} alt="Home Theater" />
                <div className="service-details">
                  <FaSolarPanel className="service-icon" />
                  <h4>Home Theatres</h4>
                  <ul className="custom-service-points">
