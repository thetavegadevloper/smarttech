 ...
 <h1 class="heading fadeIn mt-5" >Our Services</h1>
    ...
    <div class="service-container">
        ...
        <div class="service">
            ...
            <br/>
            <div class="para">   
                 <p>  Designed to deliver unparalleled audiovisual excellence, our home theaters transform any space into a captivating entertainment destination where you can immerse yourself in your favorite movies, TV shows, and games like never before.</p>
            </div> 
        </div>
    </div>
 {/* footer start   */}
