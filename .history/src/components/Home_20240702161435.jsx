...
import favicon from "../img/reallogo.png"
  ...
  return (
    ...
    <nav className="custom-navbar navbar navbar-expand-lg sticky-top">
        <div className="container-fluid">
            <Link className="navbar-brand me-auto" to="/"><img src={favicon} alt="Logo" height="60px"/></Link>
            <span className="text-warning bg-white"> Smart Tech Solutions</span>
