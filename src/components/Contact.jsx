  ...
  return (
    <>
      ...
      <div
        ...
        style={{ margin: "6rem 0 ", backgroundColor: "rgb(247, 247, 247)" }}
      >
            ...
            >
              <div className="p-lg-5 ps-lg-0">
                ...
                <p className="mb-4">
                  ...
                  to every message promptly. Our team is dedicated to providing
                  excellent customer service and ensuring your experience with
                  us is exceptional.
                </p>
                <form>
                  <div className="row g-3">
                    ...
                    <div className="col-12">
                      <button
                        className="btn btn-warning py-3 px-5  text-white"
                        type="submit"
                      >
                        Send Message
                      </button>
            ...
            >
              <div className="p-lg-5 pe-lg-0">
                ...
                <p className="mb-4 pb-2">
                  Each solar project is unique. Fill out the form below with
                  your specifics, and our experts will tailor a solution that
                  meets your energy needs and budget.
                </p>
                <form>
                  <div className="row g-3">
